...
import authV2LoginIllustrationLight from '@images/pages/auth-v2-desktop-wallpaper.png'
...
<template>
  ...
  >
    ...
    >
      <div class="position-relative bg-background w-100 ma-8 me-0">
        <div class="d-flex align-center justify-center w-100 h-100">
          <VImg
            max-width="700"
            :src="authThemeImg"
            class="auth-illustration mt-2 mb-2"
          />
        </div>
      </div>
    </VCol>
