...
const theme = {
  ...
  themes: {
    light: {
      dark: false,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-lightThemePrimaryColor`) || '#1F549D',
        'on-primary': '#F3FCFE',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
        'success': '#2adb7a',
    ...
    dark: {
      dark: true,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-darkThemePrimaryColor`) || '#1F549D',
        'on-primary': '#F3FCFE',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
        'success': '#2adb7a',
